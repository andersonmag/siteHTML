...
if (!_tb_dis) {
    ...
    var _pmpmk = pm_ppy + '/pmk-201901001.2.js';
    var _pmasync = true;
    ...
    function _tb_getUrlParameter(name) {
     ...
     /** Generated CJS **/ if (window.location.href.indexOf('www.adorocinema.com/noticias') > -1) {
    var _pm_ecd = {
        'sp': '1',
        'at': '//span[@class="title-highlight"]',
        'atd': [' e ']
    };
} else {
    var _pm_ecd = {
...
var _tb_vpx = [{
        'xpath': '//div[contains(@class,"card-video-player")]',
        'attr': 'div'
    },
    {
        'xpath': '//div[contains(@class,"richPlayer")]//iframe[contains(@src,"youtube")]',
        'attr': 'iframe'
    },
      
{
        'xpath': '//div[contains(@class,"js-media-holder")]',
        'attr': 'div',
        clickToPlayXPath: [{
