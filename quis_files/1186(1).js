...
if ( typeof tldc.funnelSegments['1186'] == 'undefined' ) {
  tldc.funnelSegments['1186'] = [];
  var n=0;
	tldc.funnelSegments['1186'][n++] = { 'seg':'6458735', 	'step':1, 'ievs':'6458731', 'conv':'768845' };
	tldc.funnelSegments['1186'][n++] = { 'seg':'6458736', 	'step':2, 'ievs':'6458732', 'conv':'768846' };
	tldc.funnelSegments['1186'][n++] = { 'seg':'6458737', 	'step':3, 'ievs':'6458733', 'conv':'768847' };
...
for (var i = 0; i < scriptTags.length; i++) {
  ...
  if (undefined !== ssrc && null !== ssrc && ssrc.indexOf('fseg') !== -1 && ssrc.indexOf('1186.js') !== -1) {  	
    ...
    //console.log('tlfseg:'+JSON.stringify(tldc.tlfseg));
    	if ( typeof tldc.tlfseg[qs.add] === 'undefined' ) {	    		  		
    		if ( processFunnelSegVal(qs.add,qs.val,'1186',tldc.funnelSegments['1186']) ) tldc.tlfseg[qs.add] = 1;  
    	}
    }
  }
}
