...
tldc.cvPx['768845'] = {};
tldc.cvPx['768845'].a = 768845;
tldc.cvPx['768845'].l = [];
tldc.cvPx['768845'].i = 7; 
tldc.cvPx['768845'].c = 30; 
tldc.cvPx['768845'].t = 'h';
tldc.cvPx['768845'].m = 'null';
tldc.cvPx['768845'].vi = 0;
tldc.cvPx['768845'].vc = 0;
tldc.cvPx['768845'].hf = 0;
tldc.cvPx['768845'].x = tldc.xtra;
...
var TradeLabConvTracker = function (cdata) {
  ...
  if ( typeof tldc.tl_getAnalyticsData === 'undefined' && typeof tl_getAnalyticsData === 'function' ) tldc.tl_getAnalyticsData = tl_getAnalyticsData;   
    ...
    if ( !tldc.tl_check4xconv(768845) ) {
        if ( typeof tldc.tl_addXconv === 'function' ) tldc.tl_addXconv(768845);
      }
      else xval = 0;
  }
  if ( typeof document.cookie != 'undefined' ) {
    ...
    a.style.height = 0;
    a.style.width = 0;    
    if ( document.location.protocol == 'http:' ) asrc="http://ib.adnxs.com/px?id=768845";
    else asrc="https://secure.adnxs.com/px?id=768845";
...
if ( tldc.cvPx['768845'].hf == 0 ) {  
  if ( TradeLabConvTracker(stringify(tldc.cvPx['768845'])) ) tldc.cvPx['768845'].hf = 1;
}
