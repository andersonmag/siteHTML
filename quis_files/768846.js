...
if ( typeof tldc.advid === 'undefined' ) tldc.advid = '1282924';
...
tldc.cvPx['768846'] = {};
tldc.cvPx['768846'].a = 768846;
tldc.cvPx['768846'].l = [];
tldc.cvPx['768846'].i = 7; 
tldc.cvPx['768846'].c = 30; 
tldc.cvPx['768846'].t = 'h';
tldc.cvPx['768846'].m = 'null';
tldc.cvPx['768846'].vi = 0;
tldc.cvPx['768846'].vc = 0;
tldc.cvPx['768846'].hf = 0;
tldc.cvPx['768846'].x = tldc.xtra;
...
var TradeLabConvTracker = function (cdata) {
  ...
  if ( typeof tldc.tl_getAnalyticsData === 'undefined' && typeof tl_getAnalyticsData === 'function' ) tldc.tl_getAnalyticsData = tl_getAnalyticsData;   
    ...
    if ( !tldc.tl_check4xconv(768846) ) {
        if ( typeof tldc.tl_addXconv === 'function' ) tldc.tl_addXconv(768846);
      }
      else xval = 0;
  }
  if ( typeof document.cookie != 'undefined' ) {
    ...
    a.style.height = 0;
    a.style.width = 0;    
    if ( document.location.protocol == 'http:' ) asrc="http://ib.adnxs.com/px?id=768846";
    else asrc="https://secure.adnxs.com/px?id=768846";
...
if ( tldc.cvPx['768846'].hf == 0 ) {  
  if ( TradeLabConvTracker(stringify(tldc.cvPx['768846'])) ) tldc.cvPx['768846'].hf = 1;
}
